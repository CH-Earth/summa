...
# Run this from the main ngen directory:  ./extern/summa/summa/utils/test/test_ngen/example_run.sh
...
#./cmake_build/ngen ./test/data/routing/gauge_01073000.gpkg '' ./test/data/routing/gauge_01073000.gpkg '' ./extern/summa/summa/utils/test/test_ngen/gauge_01073000/settings/example_realization_config_w_summa_bmi_routing.json
