...
# colorbar axes
cax1 = fig.add_axes([0.473,0.69,0.02,0.3])
cax2 = fig.add_axes([0.97 ,0.69,0.02,0.3])
cax3 = fig.add_axes([0.473,0.36,0.02,0.3])
cax4 = fig.add_axes([0.97 ,0.36,0.02,0.3])
cax5 = fig.add_axes([0.473,0.03,0.02,0.3])
cax6 = fig.add_axes([0.97 ,0.03,0.02,0.3])
...
if stat == 'max':
    stat_word = 'Max'
axs[2,1].set_title('(f) Wall clock time '+stat_word)
axs[2,1].axis('off')
