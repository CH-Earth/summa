...
# Run this from the main ngen directory:  ./extern/summa/summa/test_ngen/provo_run.sh
...
#./cmake_build/ngen ./extern/summa/summa/test_ngen/domain_provo/settings/gage-10154200_subset.gpkg '' ./extern/summa/summa/test_ngen/domain_provo/settings/gage-10154200_subset.gpkg '' ./extern/summa/summa/test_ngen/domain_provo/settings/provo_realization_config_w_summa_bmi_routing.json
...
"${NGEN_PYTHON}" -m nwm_routing -V4 -f  ./extern/summa/summa/test_ngen/domain_provo/settings/provo_routing.yaml

rm -f extern/summa/summa/test_ngen/domain_provo/simulations/*.parquet
