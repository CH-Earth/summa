pro plot_rootingProfileHeatmap
...
simPairs = [ ['011', '014'], $      ; rooting profile: double exponential vs power law (2m rooting depth) 
             ['014', '016'], $      ; rooting profile: power law (2m depth) vs power law (5m depth) 
             ['011', '017'], $      ; soil stress function: Noah vs CLM 
             ['011', '019']  ]      ; soil stress function: Noah vs SSiB 

; define the title
titleVec = ['Rooting profile', $
            'Rooting profile', $
            'Soil moisture stress', $
            'Soil moisture stress']

; define x title
xtitleVec = ['Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[0] + ' = ' + 'Double exp (2m depth)' + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[1] + ' = ' + 'Power law (2m depth)'  + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[2] + ' = ' + 'Noah'                  + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[3] + ' = ' + 'Noah'                  + ']']

; define y title
ytitleVec = ['Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[0] + ' = ' + 'Power law (2m depth)'  + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[1] + ' = ' + 'Power law (5m depth)'  + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[2] + ' = ' + 'CLM4'                  + ']', $
             'Stomatal conductance (m s!e-1!n)!C' + '['+titleVec[3] + ' = ' + 'SSiB'                  + ']'  ]
...
for iCompare=0,nCompare-1 do begin
 ...
 heatMapSaveFile = 'xIDLsave/rootingProfileHeatmap_'+models[0]+'_'+models[1]+'.sav'
