pro plot_stomatalConductanceNrgFluxes
...
simPairs = [ ['004', '005'], $      ; sensible heat: linear vs hyperbolic humidity control
             ['004', '005'], $      ; latent heat: linear vs hyperbolic humidity control
             ['011', '012'], $      ; sensible heat: Ball-Berry vs Jarvis stomatal conductance 
             ['011', '012']  ]      ; latent heat:  Ball-Berry vs Jarvis stomatal conductance

; define an identifier
simVarDesire = ['Qh','Qle','Qh','Qle']

; define the title
titleVec = ['Humidity controls',    $
            'Humidity controls',    $
            'Stomatal conductance', $
            'Stomatal conductance']

; define x title
xtitleVec = ['Sensible heat (W m!e-2!n)!C' + '['+titleVec[0] + ' = ' + 'Linear'     + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[1] + ' = ' + 'Linear'     + ']', $
             'Sensible heat (W m!e-2!n)!C' + '['+titleVec[2] + ' = ' + 'Ball-Berry' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[3] + ' = ' + 'Ball-Berry' + ']']

; define y title
ytitleVec = ['Sensible heat (W m!e-2!n)!C' + '['+titleVec[0] + ' = ' + 'Hyperbolic' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[1] + ' = ' + 'Hyperbolic' + ']', $
             'Sensible heat (W m!e-2!n)!C' + '['+titleVec[2] + ' = ' + 'Jarvis'     + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[3] + ' = ' + 'Jarvis'     + ']']
...
for iCompare=0,nCompare-1 do begin
 ...
 heatMapSaveFile = 'xIDLsave/controlsNrgFluxesHeatmap_'+models[0]+'_'+models[1]+'_'+simVarDesire[iCompare]+'.sav'
...
; write figure
write_png, 'figures/controlsNrgFluxes.png', tvrd(true=1)
