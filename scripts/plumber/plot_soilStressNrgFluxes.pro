...
simPairs = [ ['011', '017'], $      ; sensible heat: Noah vs CLM 
             ['011', '017'], $      ; latent heat: Noah vs CLM 
             ['011', '019'], $      ; sensible heat: Noah vs SSiB
             ['011', '019']  ]      ; latent heat: Noah vs SSiB

; define an identifier
simVarDesire = ['Qh','Qle','Qh','Qle']

; define the title
titleVec = ['Soil stress function',    $
            'Soil stress function',    $
            'Soil stress function', $
            'Soil stress function']

; define x title
xtitleVec = ['Sensible heat (W m!e-2!n)!C' + '['+titleVec[0] + ' = ' + 'Noah' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[1] + ' = ' + 'Noah' + ']', $
             'Sensible heat (W m!e-2!n)!C' + '['+titleVec[2] + ' = ' + 'Noah' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[3] + ' = ' + 'Noah' + ']']

; define y title
ytitleVec = ['Sensible heat (W m!e-2!n)!C' + '['+titleVec[0] + ' = ' + 'CLM4' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[1] + ' = ' + 'CLM4' + ']', $
             'Sensible heat (W m!e-2!n)!C' + '['+titleVec[2] + ' = ' + 'SSiB' + ']', $
             'Latent heat (W m!e-2!n)!C'   + '['+titleVec[3] + ' = ' + 'SSiB' + ']']
...
for iCompare=0,nCompare-1 do begin
 ...
 heatMapSaveFile = 'xIDLsave/soilStressNrgFluxesHeatmap_'+models[0]+'_'+models[1]+'_'+simVarDesire[iCompare]+'.sav'
...
; write figure
write_png, 'figures/soilStressNrgFluxes.png', tvrd(true=1)
