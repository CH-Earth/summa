pro plot_stomatalNumerixHeatmap

; define plotting parameters
window, 0, xs=1300, ys=600, retain=2
device, decomposed=0
LOADCT, 39
!P.BACKGROUND=255
!P.CHARSIZE=1.5
...
simPairs = [ ['001', '002'], $      ; Noah-MP vs Rewton Raphson solution 
             ['005', '007']  ]      ; minFunc vs colimitation

; define the title
titleVec = ['Numerical solution', $
            'Assimilation control']

; define x title
xtitleVec = ['Stomatal conductance (mm s!e-1!n)!C' + '['+titleVec[0] + ' = ' + 'Noah-MP'     + ']', $
             'Stomatal conductance (mm s!e-1!n)!C' + '['+titleVec[1] + ' = ' + 'Min function'  + ']']

; define y title
ytitleVec = ['Stomatal conductance (mm s!e-1!n)!C' + '['+titleVec[0] + ' = ' + 'Newton-Raphson'        + ']', $
             'Stomatal conductance (mm s!e-1!n)!C' + '['+titleVec[1] + ' = ' + 'Colimitation'    + ']'        ]
...
for iCompare=0,nCompare-1 do begin
 ...
 heatMapSaveFile = 'xIDLsave/stomatalNumerixHeatmap_'+models[0]+'_'+models[1]+'.sav'
...
; write figure
write_png, 'figures/stomatalNumerix.png', tvrd(true=1)
