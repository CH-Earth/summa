pro plot_humidityControlObsNrgFluxes
...
simPairs = [ ['obs', '013'], $      ; linear humidity control vs obs
             ['obs', '014'], $      ; hyperbolic humidity control vs obs
             ['013', '014']  ]      ; linear vs hyperbolic humidity control
...
xtitleVec = ['Observations', $
             'Observations', $
             'SUMMA [linear humidity control]']

; define y title
ytitleVec = ['SUMMA [linear humidity control]', $
             'SUMMA [hyperbolic humidity control]', $
             'SUMMA [hyperbolic humidity control]']
...
; write figure
write_png, 'figures/humidityControlsObsNrgFluxes.png', tvrd(true=1)
