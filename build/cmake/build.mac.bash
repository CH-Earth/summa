...
export INCLUDES_DIRS='/usr/local/include;/usr/local/lib;/usr/include'      # directories for INCLUDES cmake variable (cmake uses semicolons as separators)
export LIBRARY_LINKS='-llapack;-lgfortran;-lnetcdff;-lnetcdf' # list of library links (cmake uses semicolons as separators)

cmake -B ../cmake_build_reg -S . -DCMAKE_BUILD_TYPE=Sundials
cmake --build ../cmake_build_reg --target all