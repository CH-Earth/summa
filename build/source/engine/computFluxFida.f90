...
implicit none
private
public::computFluxFida
public::soilCmpres
contains

 ! *********************************************************************************************************
 ! public subroutine computFluxFida: compute model fluxes
 ! *********************************************************************************************************
 subroutine computFluxFida(&
 ...
 if(nSnowOnlyHyd>0)then
  ...
  call snowLiqFlxFida(&
                  ...
                  mLayerVolFracIce(1:nSnow),				 & ! intent(in)		
 ...
 if(nSoilOnlyHyd>0)then
  ...
  ! topmodel-ish shallow groundwater
   ...
   call groundwatr(&
                   ...
                   mLayerdTheta_dPsi,                       & ! intent(in):    derivative in the soil water characteristic w.r.t. matric head
...
end module computFluxFida_module
