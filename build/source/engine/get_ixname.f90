...
contains
 ...
 select case(trim(varName))
  ...
  case('scalarInitTranspireAqfr'); get_ixmvar = iLookMVAR%scalarInitTranspireAqfr ! transpiration loss from the aquifer at the start-of-step (m s-1)
  case('scalarTranspireAqfr'    ); get_ixmvar = iLookMVAR%scalarTranspireAqfr     ! transpiration loss from the aquifer at the end-of-step (m s-1)
