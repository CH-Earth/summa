...
contains
 ...
 real(dp)                             :: balanceSoilWater0        ! total soil storage at the start of the step
 real(dp)                             :: balanceSoilWater1        ! total soil storage at the end of the step
 ...
 balanceSoilTranspiration = scalarMassLiquid*dt
