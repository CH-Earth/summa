...
contains
 ...
 real(summa_prec)                         :: realVec(nHRUrun)  ! real vector for all HRUs in the run domain
 real(summa_prec)                         :: realArray(nHRUrun,maxLayers+1)  ! real array for all HRUs in the run domain
