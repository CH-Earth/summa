...
contains
 ...
 integer(i4b)                       :: iFreq           ! loop through output frequencies
 real(summa_prec)                           :: elpSec          ! elapsed seconds
 ...
 write(outunit,"(A,1PG15.7,A)")                                               '       or           ', elpSec/60_summa_prec,          ' m'
 write(outunit,"(A,1PG15.7,A)")                                               '       or           ', elpSec/3600_summa_prec,        ' h'
 write(outunit,"(A,1PG15.7,A/)")                                              '       or           ', elpSec/86400_summa_prec,       ' d'
