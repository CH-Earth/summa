...
contains
 ...
 greenVegFrac_monthly = (/0.01_summa_prec, 0.02_summa_prec, 0.03_summa_prec, 0.07_summa_prec, 0.50_summa_prec, 0.90_summa_prec, 0.95_summa_prec, 0.96_summa_prec, 0.65_summa_prec, 0.24_summa_prec, 0.11_summa_prec, 0.02_summa_prec/)
 ...
 do iGRU=1,nGRU
  ...
  do iHRU=1,gru_struc(iGRU)%hruCount
   upArea%gru(iGRU)%hru(iHRU) = 0._summa_prec
   do jHRU=1,gru_struc(iGRU)%hruCount
