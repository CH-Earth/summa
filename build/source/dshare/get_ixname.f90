...
contains
 ...
 select case(trim(varName))
  ...
  case('absConvTol_liquid'        ); get_ixparam = iLookPARAM%absConvTol_liquid      ! absolute convergence tolerance for vol frac liq water (-) be_numrec
  case('relConvTol_matric'        ); get_ixparam = iLookPARAM%relConvTol_matric      ! relative convergence tolerance for matric head (-) be_numrec
  case('absConvTol_matric'        ); get_ixparam = iLookPARAM%absConvTol_matric      ! absolute convergence tolerance for matric head (m) be_numrec
  case('relConvTol_energy'        ); get_ixparam = iLookPARAM%relConvTol_energy      ! relative convergence tolerance for energy (-) be_numrec
  ...
  case('relErrTol_ida'            ); get_ixparam = iLookPARAM%relErrTol_ida          ! relative error tolerance for sundials ida
  case('absErrTol_ida'            ); get_ixparam = iLookPARAM%absErrTol_ida          ! absolute error tolerance for sundials ida
