...
contains
 ...
 flux2state_orig(iLookFLUX%scalarCanairNetNrgFlux)         = flux2state(state1=iname_nrgCanair, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarCanopyNetNrgFlux)         = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer) 
 flux2state_orig(iLookFLUX%scalarGroundNetNrgFlux)         = flux2state(state1=iname_nrgLayer,  state2=iname_nrgCanopy)
 ...
 flux2state_orig(iLookFLUX%scalarLWRadCanopy)               = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadGround)               = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadUbound2Canopy)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarLWRadCanopy2Ubound)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadCanopy2Ground)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadCanopy2Canopy)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadGround2Ubound)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWRadGround2Canopy)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLWNetCanopy)               = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarEddyDiffusCanopyTop)       = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarFrictionVelocity)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarWindspdCanopyTop)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarWindspdCanopyBottom)       = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarGroundResistance)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarCanopyResistance)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLeafResistance)            = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarSenHeatCanopy)             = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarLatHeatCanopyEvap)         = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLatHeatCanopyTrans)        = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarLatHeatGround)             = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarCanopyAdvectiveHeatFlux)   = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarGroundAdvectiveHeatFlux)   = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarCanopySublimation)         = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarStomResistSunlit)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarStomResistShaded)          = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarPhotosynthesisSunlit)      = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 flux2state_orig(iLookFLUX%scalarPhotosynthesisShaded)      = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%scalarCanopyEvaporation)         = flux2state(state1=iname_nrgCanopy, state2=iname_nrgLayer)
 ...
 flux2state_orig(iLookFLUX%mLayerSatHydCondMP)              = flux2state(state1=iname_matLayer,  state2=integerMissing)
 flux2state_orig(iLookFLUX%mLayerSatHydCond)                = flux2state(state1=iname_matLayer,  state2=integerMissing)
 flux2state_orig(iLookFLUX%iLayerSatHydCond)                = flux2state(state1=iname_matLayer,  state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%mLayerColumnInflow)              = flux2state(state1=iname_matLayer,  state2=integerMissing)
