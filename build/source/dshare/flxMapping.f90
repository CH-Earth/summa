...
contains
 ...
 flux2state_orig(iLookFLUX%scalarGroundNetNrgFlux)          = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarLWRadGround)               = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarLWRadUbound2Canopy)        = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarLWRadUbound2Ground)        = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarLWRadUbound2Ubound)        = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarLWRadGround2Ubound)        = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarLWNetGround)               = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarLWNetUbound)               = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarGroundResistance)          = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarSenHeatTotal)              = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarSenHeatCanopy)             = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarSenHeatGround)             = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarLatHeatTotal)              = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarLatHeatGround)             = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarCanopyAdvectiveHeatFlux)   = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarGroundAdvectiveHeatFlux)   = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarCanopySublimation)         = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarSnowSublimation)           = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 ...
 flux2state_orig(iLookFLUX%scalarCanopyTranspiration)       = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarCanopyEvaporation)         = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
 flux2state_orig(iLookFLUX%scalarGroundEvaporation)         = flux2state(state1=iname_nrgCanopy, state2=integerMissing)
