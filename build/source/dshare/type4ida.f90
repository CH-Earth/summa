...
type data4ida
  ...
  real(rkind), allocatable        :: mLayerTempPrime(:)              ! prime value for temperature of each snow and soil layer (K s-1)
  real(rkind), allocatable        :: mLayerMatricHeadPrime(:)        ! prime value for matric head of each snow and soil layer (m s-1)
