...
subroutine popMetadat(err,message)
  ...
  mpar_meta(iLookPARAM%relErrTol_ida)         = var_info('relErrTol_ida'         , 'relative error tolerance for sundials ida'                        , '-'               , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  mpar_meta(iLookPARAM%absErrTol_ida)         = var_info('absErrTol_ida'         , 'absolute error tolerance for sundials ida'                        , '-'               , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
