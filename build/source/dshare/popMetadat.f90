...
! enthalpy
 ...
 deriv_meta(iLookDERIV%dCanopyNetFlux_dCanLiq)        = var_info('dCanopyNetFlux_dCanLiq'       , 'derivative in net canopy fluxes w.r.t. canopy total water content'    , 'J kg-1 s-1'     , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 ...
 deriv_meta(iLookDERIV%dGroundNetFlux_dCanLiq)        = var_info('dGroundNetFlux_dCanLiq'       , 'derivative in net ground fluxes w.r.t. canopy total water content'    , 'J kg-1 s-1'     , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 ...
 deriv_meta(iLookDERIV%dCanopyEvaporation_dCanLiq)    = var_info('dCanopyEvaporation_dCanLiq'   , 'derivative in canopy evaporation w.r.t. canopy total water content'   , 's-1'            , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 ...
 deriv_meta(iLookDERIV%dGroundEvaporation_dCanLiq)    = var_info('dGroundEvaporation_dCanLiq'   , 'derivative in ground evaporation w.r.t. canopy total water content'   , 's-1'            , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 ...
 deriv_meta(iLookDERIV%scalarThroughfallSnowDeriv)    = var_info('scalarThroughfallSnowDeriv'   , 'derivative in snow throughfall w.r.t. canopy ice'                     , 's-1'            , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 deriv_meta(iLookDERIV%scalarCanopySnowUnloadingDeriv)= var_info('scalarCanopySnowUnloadingDeriv', 'derivative in unloading of snow w.r.t. canopy ice'                   , 's-1'            , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
 deriv_meta(iLookDERIV%scalarCanopySnowUnload_TkDeriv)= var_info('scalarCanopySnowUnload_TkDeriv', 'derivative in unloading of snow w.r.t. canopy air temperature'       , 'K-1'            , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
