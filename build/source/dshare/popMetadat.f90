...
subroutine popMetadat(err,message)
  ...
  ! balances
  diag_meta(iLookDIAG%balanceCasNrg)                   = var_info('balanceCasNrg'                  , 'balance of energy in the canopy air space'                                  , 'W m-2'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceVegNrg)                   = var_info('balanceVegNrg'                  , 'balance of energy in the vegetation'                              , 'W m-2'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceSnowNrg)                  = var_info('balanceSnowNrg'                 , 'balance of energy in the snow'                                    , 'W m-2'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceSoilNrg)                  = var_info('balanceSoilNrg'                 , 'balance of energy in the soil'                                    , 'W m-2'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceVegMass)                  = var_info('balanceVegMass'                 , 'balance of water in the vegetation'                               , 'kg m-2'          , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceSnowMass)                 = var_info('balanceSnowMass'                , 'balance of water in the snow'                                     , 'kg m-2'          , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceSoilMass)                 = var_info('balanceSoilMass'                , 'balance of water in the soil'                                     , 'kg m-2'          , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  diag_meta(iLookDIAG%balanceAqMass)                   = var_info('balanceAqMass'                  , 'balance of water in the aquifer'                                  , 'kg m-2'          , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ! -----
  ! * local model fluxes...
  ! -----------------------
