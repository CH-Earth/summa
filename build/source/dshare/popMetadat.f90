...
subroutine popMetadat(err,message)
  ...
  mpar_meta(iLookPARAM%maxiter)               = var_info('maxiter'               , 'maximum number of iterations numrec, kinsol, or nonlinear iterations Sundials', '-'         , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
