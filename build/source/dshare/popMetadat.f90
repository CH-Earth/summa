...
subroutine popMetadat(err,message)
  ...
  deriv_meta(iLookDERIV%dAquiferTrans_dCanWat)         = var_info('dAuiferTrans_dCanWat'         , 'derivative in the aquifer transpiration flux w.r.t. canopy total water',   'm-1 s-1 kg-1', get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
