...
contains
 ...
 indx_meta(iLookINDEX%ixAquifer)             = var_info('ixAquifer'            , 'indices IN THE FULL VECTOR for the aquifer'                              , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
