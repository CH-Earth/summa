...
contains
 ...
 indx_meta(iLookINDEX%ixAllState_subset)   = var_info('ixAllState_subset'  , '[state subset] list of indices in the full state vector'                , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 ...
 indx_meta(iLookINDEX%ixSnowSoilNrg)      = var_info('ixSnowSoilNrg'       , 'indices IN THE STATE SUBSET for energy states in the snow+soil domain'  , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%ixSnowSoilWat)      = var_info('ixSnowSoilWat'       , 'indices IN THE STATE SUBSET for total water states in snow+soil domain' , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%ixSnowOnlyNrg)      = var_info('ixSnowOnlyNrg'       , 'indices IN THE STATE SUBSET for energy states in the snow domain'       , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%ixSnowOnlyWat)      = var_info('ixSnowOnlyWat'       , 'indices IN THE STATE SUBSET for total water states in the snow domain'  , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%ixSoilOnlyNrg)      = var_info('ixSoilOnlyNrg'       , 'indices IN THE STATE SUBSET for energy states in the soil domain'       , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%ixSoilOnlyHyd)      = var_info('ixSoilOnlyHyd'       , 'indices IN THE STATE SUBSET for hydrology states in the soil domain'    , '-', get_ixVarType('unknown'), lFalseArry, integerMissing, iMissArry)
