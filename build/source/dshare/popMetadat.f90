...
contains
 ...
 indx_meta(iLookINDEX%ixSnowSoilNrg)     = var_info('ixSnowSoilNrg'    , 'indices IN THE FULL VECTOR for energy states in the snow-soil domain' , '-', 'unknown', .false.)
 indx_meta(iLookINDEX%ixSnowSoilWat)     = var_info('ixSnowSoilWat'    , 'indices IN THE FULL VECTOR for total water states in snow-soil domain', '-', 'unknown', .false.)
 indx_meta(iLookINDEX%ixSnowOnlyNrg)     = var_info('ixSnowOnlyNrg'    , 'indices IN THE FULL VECTOR for energy states in the snow domain'      , '-', 'unknown', .false.)
 indx_meta(iLookINDEX%ixSnowOnlyWat)     = var_info('ixSnowOnlyWat'    , 'indices IN THE FULL VECTOR for total water states in the snow domain' , '-', 'unknown', .false.)
 indx_meta(iLookINDEX%ixSoilOnlyNrg)     = var_info('ixSoilOnlyNrg'    , 'indices IN THE FULL VECTOR for energy states in the soil domain'      , '-', 'unknown', .false.)
 indx_meta(iLookINDEX%ixSoilOnlyHyd)     = var_info('ixSoilOnlyHyd'    , 'indices IN THE FULL VECTOR for hydrology states in the soil domain'   , '-', 'unknown', .false.)
