...
MODULE var_lookup
 ...
 type, public  ::  iLook_param
  ...
  integer(i4b)    :: constSnowDen              = 28  ! Constant new snow density (kg m-3)
  integer(i4b)    :: a_sn                      = 29  ! Pahaut 1976 param (kg m-3)  
  integer(i4b)    :: b_sn                      = 30  ! Pahaut 1976 param (kg m-3 K-1)
  integer(i4b)    :: c_sn                      = 31  ! Pahaut 1976 param (kg m-7/2 s-1/2)
  integer(i4b)    :: d_sn                      = 32  ! Oleson et al. 2002 param (K-1)
  integer(i4b)    :: e_sn                      = 33  ! Oleson et al. 2002 param (K)
  ! snow compaction
