MODULE var_lookup
 ...
 type, public :: iLook_mvar
  ...
  integer(i4b)    :: mLayerInitQMacropore            = 168 ! liquid flux from micropores to macropores at the start-of-step (m s-1)
  integer(i4b)    :: mLayerQMacropore                = 169 ! liquid flux from micropores to macropores (m s-1)
